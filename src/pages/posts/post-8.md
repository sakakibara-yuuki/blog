...
title: "CSS基礎"
author: "sakakibara"
description: "html & cssは小学生でも書ける。しかし、うまく書くにはそれなりの知識と経験
が求められる。"
image:
...
だが、実際にはhtml & cssを何のリファレンスも見ずに書ける人、保守性まで考慮したコードを書ける人は本当に極小数であると思う。  
何よりも自分はhtml & cssを**うまく(保守性を考慮して適切な方法で)** 書けるとは思えていない。  

以降ではいくつか自分が未熟だと感じるhtml&css技術について学習記録をまとめる。  
